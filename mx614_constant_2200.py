"""Simple bench test: keep TXD fixed to request the high Bell 202 tone.
...
def main():
    ...
    print("TXD fixed at 0")
    print("Expected tone: approximately 2200 Hz if the current assumption is correct")
